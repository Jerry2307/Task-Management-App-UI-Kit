...
class FontSizes {
  ...
  static final double fontSize165 = 16.5.sp;
  ...
  static final double fontSize60 = 60.sp;
  static final double fontSize96 = 96.sp;

  static final double kDefaultPadding = 15.sp;
